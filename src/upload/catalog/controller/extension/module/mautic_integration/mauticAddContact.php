...
class ControllerExtensionModuleMauticIntegrationMauticAddContact extends Controller {
	...
	public function index($args) {
		...
		$this->ml->write(sprintf($this->language->get('text_event_add_contact'), $customer_id));
